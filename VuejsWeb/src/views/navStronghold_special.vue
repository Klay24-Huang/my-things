    ...
    <div>
        ...
        <div class="container text-left">
            <p class="text-secondary my-2">
                據點管理 / 
                <font-awesome-icon icon="file-alt"></font-awesome-icon> 停車便利付停車場設定
            </p>
        </div>
        <main class="bg-gray-400">
            ...
            <div class="container text-left" :class="{ 'd-none': !isInquired}">
                <b-table striped hover :items="items" :fields="fields" class="bg-white mt-4 table_narrow" head-row-variant="primary" responsive="sm">
    ...
    data() {
        return {
            ...
            fields: [
                ...
                {key:'name', label:'名稱'},
                {key:'company', label:'營建商'},
                {key:'address', label:'地址'},
                {key:'price', label:'收費金額'},
                {key:'map', label:'地圖'},
                {key:'edit', label:''},
                // {key:'x', label:'經度'},
                // {key:'y', label:'緯度'},
            ...
            items: [ 
            { index:1,isEditing: false, age: 40, name: 'Dickerson', company: 'Macdonald',address:'臺北市信義區市府路45號',price:1,map: 'map',edit: 'edit',x:0.0,y:1.1,start:'yyyy-mm-dd',end:'yyyy-mm-dd' },
            { index:2,isEditing: false, age: 21, name: 'Larsen', company: 'Shaw',address:'臺北市信義區市府路45號',price:1,map: 'map',edit: 'edit',x:0.0,y:1.1,start:'yyyy-mm-dd',end:'yyyy-mm-dd' },
            {
                index:3,
                isEditing: false,
                age: 89,
                name: 'Geneva',
                company: 'Wilson',address:'臺北市信義區市府路45號',price:1,
                map: 'map',edit: 'edit',x:0.0,y:1.1,start:'yyyy-mm-dd',end:'yyyy-mm-dd'
            },
            { 
                index:4,
                isEditing: true, age: 38, name: 'Jami', company: 'Carney',address:'臺北市信義區市府路45號',price:1,map: 'map',edit: 'edit',x:0.0,y:1.1,start:'yyyy-mm-dd',end:'yyyy-mm-dd' }
            ]
        }
    },
    computed: {
