...
namespace WebAPI.Models.Param.Output.PartOfParam
{
    ...
    public class RentBase
    {
        ...
        /// 每小時基本租金
        /// </summary>
        public int RentBasicPrice { set; get; }
        /// <summary>
        /// 車輛租金
        /// </summary>
        ...
        /// 哩程費用
        /// </summary>
        public int MileageRent { set; get; }
        /// <summary>
        /// ETAG費用
        /// </summary>
        public int ETAGRental { set; get; }
        /// <summary>
        /// 逾時費用
        /// </summary>
        public int OvertimeRental { set; get; }
        /// <summary>
        /// 總計
        /// </summary>
        public int TotalRental { set; get; }
        ...
        /// 轉乘優惠，輸出時要*-1
        /// </summary>
        public int TransferPrice { set; get; }
        /// <summary>
        /// 安心保，純租金
        /// </summary>
        ...
        /// 安心保，延長費用
        /// </summary>
        public int InsuranceExtPrice { set; get; }
    }
}