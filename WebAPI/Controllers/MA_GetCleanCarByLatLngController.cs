...
namespace WebAPI.Controllers
{
    ...
    public class MA_GetCleanCarByLatLngController : ApiController
    {
        ...
        public Dictionary<string, object> DoMA_GetCleanCarByLatLng(Dictionary<string, object> value)
        {
            ...
            string funName = "MA_GetCleanCarByLatLngController";
            Int64 LogID = 0;
            Int16 ErrType = 0;
            IAPI_MA_GetCleanCarByLatLng apiInput = null;
            ...
            if (flag)
            {
                apiInput = Newtonsoft.Json.JsonConvert.DeserializeObject<IAPI_MA_GetCleanCarByLatLng>(Contentjson);
                //寫入API Log
            ...
            string spName = "usp_MA_SaveClearMemberData";
            SPInput_MA_SaveClearMemberData spInput = new SPInput_MA_SaveClearMemberData()
            {
                Account = apiInput.Account,
                Lat = Convert.ToDecimal(apiInput.lat),
                Lng = Convert.ToDecimal(apiInput.lng),
                Station = ManageStation
            };
            SPOutput_Base spOut = new SPOutput_Base();

            flag = new SQLHelper<SPInput_MA_SaveClearMemberData, SPOutput_Base>(WebApiApplication.connetStr).ExecuteSPNonQuery(spName, spInput, ref spOut, ref lstError);
            ...
            try
            {
                ...
                {
                    case 0:
                        List<CarCleanDataNew> lstNor = _repository.GetCleanCarData(0, ManageStation, apiInput.lng, apiInput.lat, apiInput.raduis);
                        ...
                        break;
                    case 1:
                        List<CarCleanDataNew> lstAny = _repository.GetCleanCarData(1, ManageStation, apiInput.lng, apiInput.lat, apiInput.raduis);
                        ...
                        break;
                    case 4:
                        List<CarCleanDataNew> lstMoto = _repository.GetCleanMotoData(ManageStation, apiInput.lng, apiInput.lat, apiInput.raduis);
                        ...
                        break;
                    case 5:
                        List<CarCleanDataNew> lstNorT = _repository.GetCleanCarDataOfMaintenance(0, ManageStation, apiInput.lng, apiInput.lat, apiInput.raduis);
                        List<CarCleanDataNew> lstAnyT = _repository.GetCleanCarDataOfMaintenance(1, ManageStation, apiInput.lng, apiInput.lat, apiInput.raduis);
                        List<CarCleanDataNew> lstMotoT = _repository.GetCleanMotoDataOfMaintenance(ManageStation, apiInput.lng, apiInput.lat, apiInput.raduis);
