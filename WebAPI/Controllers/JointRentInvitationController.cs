...
namespace WebAPI.Controllers
{
    ...
    /// 案件共同承租人邀請
    /// </summary>
    public class JointRentInvitationController : ApiController
    {
        private string connetStr = ConfigurationManager.ConnectionStrings["IRent"].ConnectionString;
        [HttpPost]
        public Dictionary<string, object> DoJointRentInvitation(Dictionary<string, object> value)
        {
            #region 初始宣告
            ...
            string funName = "JointRentInvitationController";
            Int64 LogID = 0;
            Int16 ErrType = 0;
            IAPI_JointRentInvitation apiInput = null;
            ...
            if (flag)
            {
                apiInput = Newtonsoft.Json.JsonConvert.DeserializeObject<IAPI_JointRentInvitation>(Contentjson);
                //寫入API Log
