...
namespace WebAPI.Controllers
{
    ...
    /// 取得停車場，依照設定值
    /// </summary>
    public class GetParkingDataController : ApiController
    {
        private string connetStr = ConfigurationManager.ConnectionStrings["IRent"].ConnectionString;
        [HttpPost]
        public Dictionary<string, object> DoGetParkingData(Dictionary<string, object> value)
        {
            #region 初始宣告
            ...
            string funName = "GetParkingDataController";
            Int64 LogID = 0;
            Int16 ErrType = 0;
