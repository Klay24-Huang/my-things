...
namespace WebAPI.Controllers
{
    ...
    /// 【後台】取得據點列表
    /// </summary>
    public class BE_GetStationListController : ApiController
    {
        ...
        public Dictionary<string, object> doGetStationList(Dictionary<string, object> value)
        {
            ...
            string funName = "BE_GetStationListController";
            Int64 LogID = 0;
            Int16 ErrType = 0;
            IAPI_BE_Base apiInput = null;
            OAPI_BE_GetStationList apiOutput = null;
            Token token = null;
            ...
            if (flag)
            {
                ...
                List<iRentStationBaseInfo> StationList = new List<iRentStationBaseInfo>();
                StationList = _repository.GetPartOfStation(true).ToList();
                apiOutput = new OAPI_BE_GetStationList();
                apiOutput.StationList = new List<iRentStationBaseInfo>();
                apiOutput.StationList = StationList;
