                ...
                try
                {
                    ...
                    switch (DataType)
                    {
                        ...
                        case 1:
                            ...
                            var deviceMBA = 0.0;
                            var deviceRBA = 0.0;
                            MotorDataInput.deviceLBA = MotorDataInput.deviceLBA == "NA" ? "-1" : MotorDataInput.deviceLBA;
                            MotorDataInput.deviceMBA = MotorDataInput.deviceMBA == "NA" ? "-1" : MotorDataInput.deviceMBA;
                            MotorDataInput.deviceRBA = MotorDataInput.deviceRBA == "NA" ? "-1" : MotorDataInput.deviceRBA;
