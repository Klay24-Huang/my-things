            ...
            if (lstAudits != null)
            {
                ...
                for(int i = 1; i <= 11; i++)
                {
                    ...
                    if (index > -1)
                    {
                        ...
                        {
                            case 1:
                                Data.Images.ID_1 = (lstAudits[index].CrentialsFile == "") ? "" : (lstAudits[index].LSFLG == "1" ? lsURL : ImgURL) + lstAudits[index].CrentialsFile;
                                ...
                                break;
                            case 2:
                                Data.Images.ID_2 = (lstAudits[index].CrentialsFile == "") ? "" : (lstAudits[index].LSFLG == "1" ? lsURL : ImgURL) + lstAudits[index].CrentialsFile;
                                ...
                                break;
                            case 3:
                                Data.Images.Car_1 = (lstAudits[index].CrentialsFile == "") ? "" : (lstAudits[index].LSFLG == "1" ? lsURL : ImgURL) + lstAudits[index].CrentialsFile;
                                ...
                                break;
                            case 4:
                                Data.Images.Car_2 = (lstAudits[index].CrentialsFile == "") ? "" : (lstAudits[index].LSFLG == "1" ? lsURL : ImgURL) + lstAudits[index].CrentialsFile;
                                ...
                                break;
                            case 5:
                                Data.Images.Motor_1 = (lstAudits[index].CrentialsFile == "") ? "" : (lstAudits[index].LSFLG == "1" ? lsURL : ImgURL) + lstAudits[index].CrentialsFile;
                                ...
                                break;
                            case 6:
                                Data.Images.Motor_2 = (lstAudits[index].CrentialsFile == "") ? "" : (lstAudits[index].LSFLG == "1" ? lsURL : ImgURL) + lstAudits[index].CrentialsFile;
                                ...
                                break;
                            case 7:
                                Data.Images.Self_1 = (lstAudits[index].CrentialsFile == "") ? "" : (lstAudits[index].LSFLG == "1" ? lsURL : ImgURL) + lstAudits[index].CrentialsFile;
                                ...
                                break;
                            case 8:
                                Data.Images.F01 = (lstAudits[index].CrentialsFile == "") ? "" : (lstAudits[index].LSFLG == "1" ? lsURL : ImgURL) + lstAudits[index].CrentialsFile;
                                ...
                                break;
                            case 9:
                                Data.Images.Other_1 = (lstAudits[index].CrentialsFile == "") ? "" : (lstAudits[index].LSFLG == "1" ? lsURL : ImgURL) + lstAudits[index].CrentialsFile;
                                ...
                                break;
                            case 10:
                                Data.Images.Business_1 = (lstAudits[index].CrentialsFile == "") ? "" : (lstAudits[index].LSFLG == "1" ? lsURL : ImgURL) + lstAudits[index].CrentialsFile;
                                ...
                                break;
                            case 11:
                                Data.Images.Signture_1 = (lstAudits[index].CrentialsFile == "") ? "" : (lstAudits[index].LSFLG == "1" ? lsURL : ImgURL) + lstAudits[index].CrentialsFile;
                    ...
                    else
                    {
                        ...
                        if (Oindex > -1)
                        {
                            ...
                            {
                                case 1:
                                    Data.Images.ID_1 = (lstAudits[Oindex].AlreadyFile == "") ? "" : (lstAudits[Oindex].LSFLG == "1" ? lsURL : ImgURL) + lstAudits[Oindex].AlreadyFile;
                                    ...
                                    break;
                                case 2:
                                    Data.Images.ID_2 = (lstAudits[Oindex].AlreadyFile == "") ? "" : (lstAudits[Oindex].LSFLG == "1" ? lsURL : ImgURL) + lstAudits[Oindex].AlreadyFile;
                                    ...
                                    break;
                                case 3:
                                    Data.Images.Car_1 = (lstAudits[Oindex].AlreadyFile == "") ? "" : (lstAudits[Oindex].LSFLG == "1" ? lsURL : ImgURL) + lstAudits[Oindex].AlreadyFile;
                                    ...
                                    break;
                                case 4:
                                    Data.Images.Car_2 = (lstAudits[Oindex].AlreadyFile == "") ? "" : (lstAudits[Oindex].LSFLG == "1" ? lsURL : ImgURL) + lstAudits[Oindex].AlreadyFile;
                                    ...
                                    break;
                                case 5:
                                    Data.Images.Motor_1 = (lstAudits[Oindex].AlreadyFile == "") ? "" : (lstAudits[Oindex].LSFLG == "1" ? lsURL : ImgURL) + lstAudits[Oindex].AlreadyFile;
                                    ...
                                    break;
                                case 6:
                                    Data.Images.Motor_2 = (lstAudits[Oindex].AlreadyFile == "") ? "" : (lstAudits[Oindex].LSFLG == "1" ? lsURL : ImgURL) + lstAudits[Oindex].AlreadyFile;
                                    ...
                                    break;
                                case 7:
                                    Data.Images.Self_1 = (lstAudits[Oindex].AlreadyFile == "") ? "" : (lstAudits[Oindex].LSFLG == "1" ? lsURL : ImgURL) + lstAudits[Oindex].AlreadyFile;
                                    ...
                                    break;
                                case 8:
                                    Data.Images.F01 = (lstAudits[Oindex].AlreadyFile == "") ? "" : (lstAudits[Oindex].LSFLG == "1" ? lsURL : ImgURL) + lstAudits[Oindex].AlreadyFile;
                                    ...
                                    break;
                                case 9:
                                    Data.Images.Other_1 = (lstAudits[Oindex].AlreadyFile == "") ? "" : (lstAudits[Oindex].LSFLG == "1" ? lsURL : ImgURL) + lstAudits[Oindex].AlreadyFile;
                                    ...
                                    break;
                                case 10:
                                    Data.Images.Business_1 = (lstAudits[Oindex].AlreadyFile == "") ? "" : (lstAudits[Oindex].LSFLG == "1" ? lsURL : ImgURL) + lstAudits[Oindex].AlreadyFile;
                                    ...
                                    break;
                                case 11:
                                    Data.Images.Signture_1 = (lstAudits[Oindex].AlreadyFile == "") ? "" : (lstAudits[Oindex].LSFLG == "1" ? lsURL : ImgURL) + lstAudits[Oindex].AlreadyFile;
