...
namespace Reposotory.Implement
{
    public class AccountManageRepository : BaseRepository
    {
        ...
        public List<BE_UserGroup> GetUserGroup(string UserGroupID, string UserGroupName,int OperatorID, string StartDate, string EndDate,int FuncGroupID)
        {
            bool flag = false;
            List<ErrorInfo> lstError = new List<ErrorInfo>();
        ...
        public BE_GetFuncPower GetFuncPowerByUserGroupID(int UserGroupID)
        {
            bool flag = false;
            List<ErrorInfo> lstError = new List<ErrorInfo>();
            List<BE_GetFuncPower> lstFuncGroup = null;
            ...
            {
                term += (term == "") ? "" : " AND ";
                term += "  FuncGroupID=(SELECT FuncGroupID FROM TB_UserGroup WHERE USEQNO=@UserGroupID)";
        ...
        public List<BE_SCMITEM> GetSCMITEM(string scitem)
        {
            ...
            int nowCount = 0;
            string SQL = "SELECT SCMITEM FROM TB_ScoreDef ";
