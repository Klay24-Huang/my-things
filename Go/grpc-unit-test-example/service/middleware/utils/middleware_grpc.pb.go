...
const (
	Middleware_CreateUser_FullMethodName = "/middleware.Middleware/CreateUser"
)
...
func (c *middlewareClient) CreateUser(ctx context.Context, in *CreateUserRequest, opts ...grpc.CallOption) (*CreateUserReply, error) {
...
func (UnimplementedMiddlewareServer) CreateUser(context.Context, *CreateUserRequest) (*CreateUserReply, error) {
...
var Middleware_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "service/middleware/utils/middleware.proto",
}
