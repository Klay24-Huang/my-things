CREATE TABLE [dbo].[TB_CarImageTemp]
(
    ...
    CONSTRAINT [PK_TB_CarImageTemp] PRIMARY KEY ([OrderNo], [Mode], [ImageType]) 
)

GO
EXEC sp_addextendedproperty @name = N'MS_Description',
    @value = N'是否已轉至TB_CarImage;0:否;1:是',
    @level0type = N'SCHEMA',
    @level0name = N'dbo',
    @level1type = N'TABLE',
    @level1name = N'TB_CarImageTemp',
    @level2type = N'COLUMN',
    @level2name = N'HasUpload'
GO
EXEC sp_addextendedproperty @name = N'MS_Description',
    @value = N'圖片base64，上傳後改為此照片容量',
    @level0type = N'SCHEMA',
    @level0name = N'dbo',
    @level1type = N'TABLE',
    @level1name = N'TB_CarImageTemp',
