CREATE VIEW [dbo].[VW_GetAuditList]
	AS 
	  SELECT MKTime AS ApplyDate,UPDTime AS ModifyDate,MEMCNAME,MEMIDNO,SUBSTRING(MEMIDNO,2,1) AS SEX,AuditKind,HasAudit,IsNew,SUBSTRING(MEMIDNO,10,1) AS IDNOSUFF
