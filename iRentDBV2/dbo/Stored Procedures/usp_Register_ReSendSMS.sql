		 ...
		 BEGIN
			...
			BEGIN TRAN
				...
				BEGIN
					...
					IF @hasData=0
					BEGIN  
						INSERT INTO TB_VerifyCode(IDNO,Mobile,Mode,VerifyNum,DeadLine)VALUES(@IDNO,@Mobile,0,@VerifyCode,@DeadLine);
					END
					ELSE
					BEGIN
						UPDATE TB_VerifyCode
						SET  VerifyNum=@VerifyCode,IsVerify=0,DeadLine=@DeadLine,SendTime=DATEADD(HOUR,8,GETDATE())
				...
				BEGIN
					...
					SET MEMTEL=@Mobile,HasCheckMobile=0
					WHERE MEMIDNO=@IDNO;
