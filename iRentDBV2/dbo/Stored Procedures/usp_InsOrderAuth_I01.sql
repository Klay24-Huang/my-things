...
* Example  : 
***********************************************************************************************/
CREATE PROCEDURE [dbo].[usp_InsOrderAuth_I01]
	@order_number      bigint,
	@IDNO					    varchar(10),
	@final_price             int,
	@CardType               int,
...
SET @FunName='usp_InsOrderAuth_I01';
SET @IsSystem=0;
SET @ErrorType=0;
SET @IsSystem=0;
SET @hasData=0;
...
BEGIN TRY
	 INSERT INTO TB_OrderAuth
					(A_PRGID, A_USERID, A_SYSDT, U_PRGID, U_USERID, U_SYSDT, order_number, final_price, 
								...
								CardType,AuthType,GateNO,isRetry,AutoClose)
...
END CATCH
RETURN @Error
EXECUTE sp_addextendedproperty @name = N'Platform', @value = N'API', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'PROCEDURE', @level1name = N'usp_InsOrderAuth_I01';
END
GO
EXECUTE sp_addextendedproperty @name = N'Platform', @value = N'API', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'PROCEDURE', @level1name = N'usp_InsOrderAuth_I01';
