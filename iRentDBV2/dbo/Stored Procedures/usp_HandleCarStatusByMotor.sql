		...
		BEGIN
			...
			BEGIN
				...
				SET  [ACCStatus]=@deviceACCStatus,
						...
						[device2TBA]= CASE WHEN @device2TBA IS NOT NULL AND @device2TBA > 0 THEN @device2TBA ELSE device2TBA END,
						[device3TBA]= CASE WHEN @device3TBA IS NOT NULL AND @device3TBA > 0 THEN @device3TBA ELSE device3TBA END,
						...
						[deviceMBA]= CASE WHEN @deviceMBA IS NOT NULL AND @deviceMBA > 0 THEN @deviceMBA ELSE deviceMBA END,
						...
						[deviceRBA]= CASE WHEN @deviceRBA IS NOT NULL AND @deviceRBA > 0 THEN @deviceRBA ELSE deviceRBA END,
						...
						[deviceLBA]= CASE WHEN @deviceLBA IS NOT NULL AND @deviceLBA > 0 THEN @deviceLBA ELSE deviceLBA END,
