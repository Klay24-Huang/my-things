...
* 作    者 : Umeko
* 撰寫日期 : 20211101
* 修改日期 : 20211209 UPD BY Amber REASON: 修正推播訊息內容
...
BEGIN TRY
	...
	BEGIN
		...
		Begin
				...
				Set @Title =  '取授權成功通知'
				Set  @Message =  CONCAT(N'已於',Format(@NowTime,'MM/dd hh:mm','zh-TW'),N'以末四碼',RIGHT(@CardNumber,4),N'信用卡',@ActionName,N'成功，金額',@final_price,N'，謝謝!')　--20211209 UPD BY Amber REASON: 修正推播訊息內容
