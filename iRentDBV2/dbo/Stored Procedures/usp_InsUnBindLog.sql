...
** EXEC @Error=[dbo].[usp_InsUnBindLog]    @ErrorCode OUTPUT,@ErrorMsg OUTPUT,@SQLExceptionCode OUTPUT,@SQLExceptionMsg	 OUTPUT;
...
**			 |			  |
*****************************************************************/
CREATE PROCEDURE [dbo].[usp_InsUnBindLog]
	@IDNO					VARCHAR(20)			  ,	--身分證號
	@OrderNo                VARCHAR(50)           , --解綁訂單編號
...
SET @IDNO    =ISNULL (@IDNO    ,'');
		...
		BEGIN TRY
		 ...
		 IF @Error=0
		 BEGIN
			 INSERT INTO TB_CardUnBindLog(OrderNo, IDNO, CardToken, IsSuccess, MKTime, UPDTime)
