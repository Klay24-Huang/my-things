...
* Example  : 
***********************************************************************************************/
CREATE PROCEDURE [dbo].[usp_UpdateOrderAuthReservationList_U01]
	@authSeq				BIGINT,   
	@AuthFlg				INT,     
	@AuthCode				VARCHAR(50), 
...
SET @FunName='usp_UpdateOrderAuthReservationList_U01';
SET @IsSystem=0;
SET @ErrorType=0;
SET @IsSystem=0;
SET @hasData=0;
...
EXECUTE sp_addextendedproperty @name = N'Platform', @value = N'API', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'PROCEDURE', @level1name = N'usp_UpdateOrderAuthReservationList_U01';