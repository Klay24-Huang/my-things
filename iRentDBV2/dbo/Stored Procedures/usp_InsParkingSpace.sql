...
**			 |			  |
*****************************************************************/
CREATE PROCEDURE [dbo].[usp_InsParkingSpace]
	@IDNO                   VARCHAR(10)           ,
	@OrderNo                BIGINT                ,
...
SET @FunName='usp_InsParkingSpace';
SET @IsSystem=0;
SET @ErrorType=0;
SET @IsSystem=0;
SET @hasData=0;
...
GO
EXECUTE sp_addextendedproperty @name = N'Owner', @value = N'Eric', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'PROCEDURE', @level1name = N'usp_InsParkingSpace';


GO
EXECUTE sp_addextendedproperty @name = N'MS_Description', @value = N'寫入停車格照片及位置', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'PROCEDURE', @level1name = N'usp_InsParkingSpace';


GO
EXECUTE sp_addextendedproperty @name = N'IsActive', @value = N'1:使用', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'PROCEDURE', @level1name = N'usp_InsParkingSpace';


GO
EXECUTE sp_addextendedproperty @name = N'Comments', @value = N'', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'PROCEDURE', @level1name = N'usp_InsParkingSpace';