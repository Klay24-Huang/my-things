...
SET @Refrash_Rxpires_in=ISNULL(@Rxpires_in,3600);--預設30分鐘
...
SET @hasData=0;
		BEGIN TRY
		 ...
		 BEGIN
			...
			IF @hasData=0
			BEGIN
				INSERT INTO TB_Token(MEMIDNO,Access_Token,Refrash_Token,Rxpires_in,Refrash_Rxpires_in,DeviceID,APP,APPVersion)VALUES(@MEMIDNO,@Access_Token,@Refrash_Token,@RxpiresDate,@RxpiresRefrashDate,@DeviceID,@APPKind,@APPVersion);
			END
			ELSE
			BEGIN
